...
return [
    ...
    ['method' => 'GET', 'path'  => '/index', 'handler' => 'App\Controllers\AdminController@index', 'middlewares' => [App\Middlewares\AuthMiddleware::class, App\Middlewares\RoleMiddleware::class]],
]; 
